													...
													<tbody>
														...
														?>
															<tr>
																...
																<td><a href="<?= base_url('pricelist/deletesprice/'.$price->id.'/'.$_GET['customer']) ?>" onClick="return confirm('Are you Sure?')" class="btn btn-xs btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
															</tr>
														<?php
																}
															}
														...
														?>
															<tr>
																...
																<td><a href="<?= base_url('pricelist/removesprice/'.$key.'/'.$_GET['customer']) ?>" onClick="return confirm('Are you Sure?')" class="btn btn-xs btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
															</tr>
														<?php
																}
															}
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td><a href="<?= base_url('pricelist/deletesfreight/'.$freight->id.'/'.$_GET['customer']) ?>" onClick="return confirm('Are you Sure?')" class="btn btn-xs btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
															</tr>
														<?php
																}
															}
														...
														?>
															<tr>
																...
																<td><?= $freight['charge'] ?></td>
																<td><?= $freight['remarks'] ?></td>
																<td><a href="<?= base_url('pricelist/removesfreight/'.$key.'/'.$_GET['customer']) ?>" onClick="return confirm('Are you Sure?')" class="btn btn-xs btn-danger"><i class="fa fa-times" aria-hidden="true"></i></a></td>
															</tr>
														<?php
																}
															}
  ...
  <div class="modal-dialog">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<form action="<?= base_url('pricelist/addsprice') ?>" method="POST">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
...
<div id="freight" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('pricelist/addsfreight') ?>" method="POST">
      <div class="modal-body">
	       	<div class="row">
	       		<div class="col-md-6">
					<div class="form-group">
		...
		$('#savePrice').click(function(){
			...
			if(category != null && terms !=null){
				if(terms == 'Credit' && days == null){
					...
					$.ajax({
						url: '<?= base_url("pricelist/savepricelistsupplier") ?>',
