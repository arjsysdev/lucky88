<form id="tblData" action="<?= base_url('salesorder/save') ?>" method="POST">
<section id="addsales">
	<div class="row">
		<div class="col-md-12">
			<div class="col-md-6">
		...
		<div class="col-md-12">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="so" name="cpoNum" readonly value="<?= $salesorder['cpoNum'] ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="">PO Number:</label>
					<input type="text" class="form-control" name="poNum" readonly  value="<?= $salesorder['poNum'] ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="">Date Order:</label>
					<input type="text" class="form-control datepicker" name="date_ordered" readonly  value="<?= $salesorder['date_ordered'] ?>">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label for="">Remarks:</label>
					<textarea class="form-control" name="remarks" readonly ><?= $salesorder['remarks'] ?></textarea>
				</div>
			</div>
		</div>	
	</div>
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<?php
						...
						$contact = getContactByCode($salesorder['comp_code']);
						//$subtotal = 0;
						$grosstotal = 0;
						$less1 = 0;
						$less2 = 0;
					...
					<input type="hidden" name="comp_code" value="<?= $salesorder['comp_code'] ?>">
					<?php	
					...
					<tr>
						...
						<td>
						<?php
							$dateordered = date('Y-m-d', strtotime($salesorder['date_ordered']));
							$price = getProductPrice($item['product'], $contact->contact_id, $dateordered);	
							$priceDetails = getProductPriceDetails($item['product'], $contact->contact_id, $dateordered);	
