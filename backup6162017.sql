...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2017 at 04:09 PM
...
(13, 1, '2017-06-01', '2017-06-30', 'war101', 2500, 0, 1, 1, 1, 1, 'test', '2017-06-06 04:06:51');
...
(4, 3, 'war101', 1, 2, 'aw', 2500, 1, 1, 1, 1, '2017-06-06 04:07:27');
...
(3, 'arjohn', '02158542515', 'N', 'arjohn golds', 'arjohn golds', 4, '150', 150, NULL, NULL),
(4, 'war101', '123456789', 'N', 'war101', 'war101', 1, '25', 25, NULL, NULL);
...
INSERT INTO `product_ingredients` (`ing_id`, `prod_id`, `ing_name`, `ing_qty`, `ing_unit`, `ing_material`, `ing_startDate`, `ing_endDate`) VALUES
(1, 3, '2', 2, 1, 'Corazon', '2017-05-09', '2017-05-31'),
(2, 3, '2', 2, 1, 'qwe', '2017-05-09', '2017-06-09'),
(3, 3, '3', 3, 1, '????', '2017-05-09', '2017-05-24'),
(4, 4, '2', 25, 1, 'test101', '2017-06-06', '2017-06-21');
...
(5, 'FB.png', 'test', 'test', 2, 'test', 2, 0, 0, 0, 1, '2017-05-11 05:56:07', 0, '0000-00-00 00:00:00'),
(6, 'FB1.png', 'test101', 'test101', 3, '20', 20, NULL, NULL, NULL, 1, '2017-06-06 03:17:33', 0, '0000-00-00 00:00:00');
...
--
-- Dumping data for table `receivingwh`
--

INSERT INTO `receivingwh` (`id`, `comp_code`, `refno`, `type`, `date`, `remarks`, `received_by`, `prepared_by`, `updated_by`, `date_submitted`, `date_updated`) VALUES
(1, 'ABC100', 'ABC100-21', 'TR', '2017-05-18', 'test', 0, 0, 0, '2017-05-18 06:43:22', NULL);
...
--
-- Dumping data for table `receivingwh_items`
--

INSERT INTO `receivingwh_items` (`id`, `refno`, `item_id`, `loaded`, `date_submitted`) VALUES
(1, 'ABC100-21', 1, '2', '2017-05-18 06:43:22');
...
(3, 1, 'ARJOHN', 'ARJOHN17-0003', 'ARJOHN17-0003', '2017-06-15', 'test', 5000, 50, 49.5, 49.01, 4851.5, 519.8, 4331.69, 0, 4851.5, 1, 1, '2017-06-06 04:07:27', NULL);
...
(2, 2, '2017-06-01', '2017-06-30', 'test101', 250, 0, 1, 1, 1, 1, 'test', '2017-06-14 04:09:58');
...
(2, 2, 'Special', 'Consignment', 'No Limit', '', '2017-06-14 04:09:58');
...
(1, '127.0.0.1', 'admin', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1497592383, 1, 'Ar', 'John', 'ADMIN', '0'),
